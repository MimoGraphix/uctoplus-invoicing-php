...
namespace MimoGraphix\Uctoplus;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://moje.uctoplus.sk/api/v2';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2/PHP';
    ...
    {
        $report  = 'PHP SDK (MimoGraphix\Uctoplus) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 2' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://moje.uctoplus.sk/api/v2",
            "description" => "Production",
          ),
          array(
            "url" => "https://dev.uctoplus.eu/api/v2",
            "description" => "Testing",
          )
        );
    }
