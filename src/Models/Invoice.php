...
class Invoice extends ApiModel
{
    ...
    const ATTR_DISCOUNT_VALUE = "zlava";
    ...
    public function toArray()
	{
		...
		{
			$array = [
				Invoice::ATTR_LANGUAGE_CODE => config( 'uctoplus.defaults.language' ),
				Invoice::ATTR_CURRENCY_CODE => config( 'uctoplus.defaults.currency' ),
				Invoice::ATTR_LOGO_ID => config( 'uctoplus.defaults.logo_id' ),
				Invoice::ATTR_SIGNATURE_ID => config( 'uctoplus.defaults.signature_id' ),
				Invoice::ATTR_PAYMENT_TYPE_ID => config( 'uctoplus.defaults.payment_type_id' ),
				Invoice::ATTR_DELIVERY_TYPE_ID => config( 'uctoplus.defaults.delivery_type_id' ),
				Invoice::ATTR_INVOICE_NUMBER_COUNTER => config( 'uctoplus.defaults.counters.' . ( $this->invoice_type_id == null ? Invoice::TYPE_INVOICE : $this->invoice_type_id ) ),
				Invoice::ATTR_ISSUER_NAME => config( 'uctoplus.defaults.issuer.name' ),
				Invoice::ATTR_ISSUER_PHONE => config( 'uctoplus.defaults.issuer.phone' ),
				Invoice::ATTR_ISSUER_WEB => config( 'uctoplus.defaults.issuer.web' ),
				Invoice::ATTR_ISSUER_EMAIL => config( 'uctoplus.defaults.issuer.email' ),
			];
		}

		$array[ Invoice::ATTR_INVOICE_TYPE ] = Invoice::TYPE_INVOICE;
		$array[ Invoice::ATTR_FLAG_TRANSFER_VAT ] = 0;
